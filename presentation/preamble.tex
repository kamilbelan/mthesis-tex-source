...
%% main=english keeps every caption, date and hyphenation pattern in the deck as
%% it was; the czech option is here only so \selectlanguage{czech} in the
%% appendix hyphenates the defence questions and answers with Czech patterns.
