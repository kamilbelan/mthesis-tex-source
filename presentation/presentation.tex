...
\begin{frame}{Why SPH?}
	\begin{figure}[htbp]
		\includegraphics[width=\linewidth]{figures/reference.jpg}
		\caption{Reference results: vertical component of the velocity field \href{https://doi.org/10.1175/MWR-D-10-05042.1}{Monthly Weather Review 139, 9; 10.1175/MWR-D-10-05042.1}}
...
\begin{frame}{The failure of classical SPH: field}
	\solofigure{figures/results/field_SPH.png}{Caption.}{fig:SPH_FIELD}
\end{frame}

\begin{frame}{The failure of classical SPH: norms}
	\solofigure{figures/results/norms_SPH.png}{Caption.}{fig:SPH_NORMS}
\end{frame}

\begin{frame}{The success of well-balanced $p-\theta$: field}
	\solofigure{figures/results/field_WB.png}{Caption.}{fig:WB_FIELD}
\end{frame}

\begin{frame}{The success of well-balanced $p-\theta$: norms}
...
\begingroup
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{Caption.}
		\label{fig:WAVE-EMERGENCE}
	\end{figure}
	\endgroup
\end{frame}

\begin{frame}{Tensile instability}
	% figures/results/instab_02.png
	% figures/results/instab_05.png
	% figures/results/instab_07.png
\end{frame}
...
\begin{frame}{Summary and future plans}
	\begin{columns}[T,onlytextwidth]
		...
		\textbf{Plans}
		\begin{itemize}
			\item fix tensile instability - by \eg $\delta-$SPH regularization
			\item boundary conditions, include real topography
			\item comparison with other methods: \emph{FD, FVM, DG}
		\end{itemize}
...
\begin{frame}{Opponent's questions}
	...
	Na základě zkušeností s řešením práce, jaký je potenciál částicových metod ve srovnání s "sítovými metodami" (FEM, FVM, DG) pro řešení komplikovanějších 3D úloh?
\end{frame}
